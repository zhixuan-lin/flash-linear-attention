...
from fla.ops.generalized_delta_rule.dplr.wy_fast import fwd_prepare_wy_repr 
from fla.utils import autocast_custom_bwd, autocast_custom_fwd, contiguous
from fla.ops.generalized_delta_rule.dplr.fwd_A import chunk_fwd_intra_dplr_fn 
...
@triton.jit
def chunk_generalized_dplr_delta_rule_fwd_kernel_h(
    kg,
    v,
    w,
    bg,
...
@triton.jit
def chunk_generalized_dplr_delta_rule_fwd_kernel_o(
    qg,
    v,
    v_new,
    A_qk,
...
def chunk_generalized_dplr_delta_rule_fwd_o(
    qg: torch.Tensor,
    v: torch.Tensor,
    v_new: torch.Tensor,
    A_qk: torch.Tensor,
    ...
    chunk_generalized_dplr_delta_rule_fwd_kernel_o[grid](
        qg=qg,
        v=v,
        v_new=v_new,
        A_qk=A_qk,
...
def chunk_generalized_dplr_delta_rule_fwd_h(
    kg: torch.Tensor,
    v: torch.Tensor,
    w: torch.Tensor,
    u: torch.Tensor,
    ...
    grid = (NK, NV, N * H)
    chunk_generalized_dplr_delta_rule_fwd_kernel_h[grid](
        kg=kg,
        v=v, 
        w=w,
        bg=bg,
...
def chunk_generalized_dplr_delta_rule_fwd(
    q: torch.Tensor,
    k: torch.Tensor,
    v: torch.Tensor,
    a: torch.Tensor,
    ...
    h, v_new, final_state = chunk_generalized_dplr_delta_rule_fwd_h(
        kg=kg,
        bg=bg,
        v=v,
        w=w,
    ...
    o = chunk_generalized_dplr_delta_rule_fwd_o(
        qg=qg,
        v=v,
        v_new=v_new,
        A_qk=A_qk,
...
class ChunkDPLRDeltaRuleFunction(torch.autograd.Function):
    ...
    def forward(
        ...
        o, final_state = chunk_generalized_dplr_delta_rule_fwd(
            q=q,
            k=k,
            v=v,
            a=a,
    ...
    def backward(
        ...
        raise NotImplementedError("Backward pass for ChunkGeneralizeddplrDeltaRuleFunction is not implemented yet. Stay tuned!")
